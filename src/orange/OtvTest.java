 ...
 */
public class OtvTest extends TestCase{
    ...
    public void setUp() throws Exception {
        SerialNumber serialNumber1 = new SerialNumber(BigInteger.valueOf(1));
    ...
    public void testIsValidSerialNumber() throws Exception {
        assertTrue(Otv.isValidSerialNumber(o1.getSerialNumber()));
    }
